...
$(document).ready(function() {
	$("#articles").empty();
	let Titres=["Compte-rendu", "Compte-rendu", "Compte-rendu", "Compte-rendu", "Compte-rendu"];
	let Sstitres=["Introduction et semaine du 13/01/20",
                  "Semaine du 20/01/20", 
                  "Semaine du 27/01/20", 
                  "Semaine du 03/02/20",
                  "Semaine du 02/03/20"];
	let Contenus1=[
        ...
        "<h3>Partie IHM</h3><p>L'interface a été revue et a pratiquement été achevée en matière de design et d'introduction des principaux widgets nécessaires à la manipulation du démonstrateur. Dans cette mise à jour, l'accent a été mis sur la séparation entre le code dédié à la gestion des différents éléments de la page ainsi qu'aux événements auxquels ils sont associés d'une part, et le code qui se chargera de générer les trames 802.11p à destination des véhicules d'autre part. C'est cette seconde partie qui doit monopoliser l'attention de la plupart des membres du groupe durant les dernières semaines du projet.</p> <h3>Partie contrôle et tracking</h3><p></p> <h3>Partie Réseau</h3><p></p>"
    ];
